...
function TechPill({ item }) {
  ...
  return (
    <li className="mr-6 flex-none leading-none">
      <div className="mx-2 flex cursor-default items-center gap-3 rounded-full border border-[var(--border)] bg-[color-mix(in_srgb,var(--background)_55%,transparent)] px-4 py-2 transition-colors duration-300 hover:border-[color-mix(in_srgb,var(--highlight)_50%,transparent)] md:px-5">
        {!broken && item.logoUrl ? (
          ...
          <span className="grid h-5 w-5 place-items-center rounded-sm bg-[var(--secondary)] text-[9px] font-bold">
...
export default function TechLogosMarquee() {
  ...
  return (
    <div className="relative z-20 w-full overflow-hidden border-y border-[var(--border)] bg-[var(--background)] py-8 md:py-12">
